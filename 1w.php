...
<div class="col-lg-12" style="padding: 0; margin-bottom: 50px">
    ...
    <img src="HWlogo1.png" style="background: #264F8F; width: 100%; height: 150px;" >
       ...
       ?>
        <tr>
          ...
          <td style="padding-left:  6.5em;">
           ...
           <td style="padding-left:  4em;">
            <button class="btn btn-success" id="<?php echo($row["id"]) ?>" onclick="approve(this.id)"> Accept</button> <button class="btn btn-danger" id="<?php echo($row["id"]) ?>" onclick="reject(this.id)"> reject</button>
          </td>
